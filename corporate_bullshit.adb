...
package body Corporate_Bullshit is
   ...
   begin
      case P is
         when Singular =>
            case R368 is -- assume equiprobability between explicit singular and "others => ..." items
         ...
         when Plural =>
            case R248 is -- assume equiprobability between explicit plural and "others => ..." items
